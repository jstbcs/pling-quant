...
dat <- subset(dat, read_and_decide_time < 4000)
nrow(dat)
...
**NEW** figure of observed responses on the individual level. Let's use the non-recoded for better interpretation.
...
logmodfit <- myRunner(predat
                      ...
                      , nchains = 8)
save(logmodfit, file = "outstudy1_29092023.rda")
```
...
png("Quants_curves.png", width = 1900, height = 2500, res=300)
...
png("simulation_with_threshold.png", res = 150, width = 1000, height = 700)
par(mgp = c(2, .7, 0), mar = c(3,3,1,1))
